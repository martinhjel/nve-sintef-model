...
def enmdat_utvid_dataperiode(antall_aar, model_dir, dos, navn_vassdrag,
                             scriptname="kjor_enmdat_utvid_dataperiode.script",
                             batname="kjor_enmdat_utvid_dataperiode.bat",
                             cleanup=True,
                             toscreen=True):
